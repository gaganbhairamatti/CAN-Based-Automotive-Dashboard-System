...
char scan_switch(void) {
    ...
    if (PORTBbits.RB1 == 0) return 1;
    else if (PORTBbits.RB2 == 0) return 4;
    else if (PORTBbits.RB3 == 0) return 7;
    else if (PORTBbits.RB4 == 0) return 10;
    ...
    else if (PORTBbits.RB2 == 0) return 5;
    else if (PORTBbits.RB3 == 0) return 8;
    else if (PORTBbits.RB4 == 0) return 11;


    PORTBbits.RB5 = 1;
    PORTBbits.RB6 = 1;
    PORTBbits.RB7 = 0;PORTBbits.RB7 = 0;


    if (PORTBbits.RB1 == 0) return 3;
    else if (PORTBbits.RB2 == 0) return 6;
    else if (PORTBbits.RB3 == 0) return 9;
    else if (PORTBbits.RB4 == 0) return 12;
